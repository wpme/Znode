/* src/config/ZNDECoin-config.h.  Generated from ZNDECoin-config.h.in by configure.  */
/* src/config/ZNDECoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ZNDE_CONFIG_H

#define ZNDE_CONFIG_H
...
#define PACKAGE_NAME "ZNDECoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ZNDECoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ZNDECoin"
