...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ZNDECoin: 1 day
        nTargetSpacing = 1 * 60;  // ZNDECoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 20;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a33914e2e2e71d71d10a323b59ded8ba35f047fd8dca8a1af232b9d7f661590a409219f63e2b3b707c73d638d4d3b290d061927bb47598109452cc40e5c3227b") << OP_CHECKSIG;
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ZNDECoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ZNDECoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ZNDECoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ZNDECoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ZNDECoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // ZNDECoin: 1 day
        nTargetSpacing = 1 * 60;        // ZNDECoin: 1 minutes
