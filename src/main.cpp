...
#if defined(NDEBUG)
#error "ZNDECoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 1) nSubsidy = 250000 * COIN;
    else if (nHeight > 1 && nHeight < 1000) nSubsidy = 1 * COIN;
    else if (nHeight >= 1000 && nHeight < 5000) nSubsidy = 15.5 * COIN;
    else if (nHeight >= 5000 && nHeight < 7000) nSubsidy = 3.4 * COIN;
    else if (nHeight >= 7000 && nHeight < 10000) nSubsidy = 5.7 * COIN;
    else if (nHeight >= 10000 && nHeight < 12000) nSubsidy = 6.2 * COIN;
    else if (nHeight >= 12000 && nHeight < 15000) nSubsidy = 6.2 * COIN;
    else if (nHeight >= 15000 && nHeight < 17000) nSubsidy = 6.2 * COIN;
    else if (nHeight >= 17000 && nHeight < 20000) nSubsidy = 6.2 * COIN;
    else if (nHeight >= 20000 && nHeight < 30000) nSubsidy = 6.8 * COIN;
    else if (nHeight >= 30000 && nHeight < 50000) nSubsidy = 6.3 * COIN;
    else if (nHeight >= 50000 && nHeight < 60000) nSubsidy = 5.7 * COIN;
    else if (nHeight >= 60000 && nHeight < 70000) nSubsidy = 5.3 * COIN;
    else if (nHeight >= 70000 && nHeight < 80000) nSubsidy = 5 * COIN;
    else if (nHeight >= 80000 && nHeight < 90000) nSubsidy = 4 * COIN;
    else if (nHeight >= 90000 && nHeight < 100000) nSubsidy = 4.5 * COIN;
    else if (nHeight >= 100000 && nHeight < 110000) nSubsidy = 5 * COIN;
    else if (nHeight >= 110000 && nHeight < 120000) nSubsidy = 5.5 * COIN;
    else if (nHeight >= 120000 && nHeight < 130000) nSubsidy = 6 * COIN;
    else if (nHeight >= 130000 && nHeight < 140000) nSubsidy = 6.5 * COIN;
    else if (nHeight >= 140000 && nHeight < 150000) nSubsidy = 7 * COIN;
    else if (nHeight >= 150000 && nHeight < 160000) nSubsidy = 7.5 * COIN;
    else if (nHeight >= 160000 && nHeight < 170000) nSubsidy = 8 * COIN;
    else if (nHeight >= 170000 && nHeight < 180000) nSubsidy = 8.5 * COIN;
    else if (nHeight >= 180000 && nHeight < 190000) nSubsidy = 9 * COIN;
    else if (nHeight >= 190000 && nHeight < 200000) nSubsidy = 9.5 * COIN;
    else if (nHeight >= 200000 && nHeight < 210000) nSubsidy = 10 * COIN;
    else if (nHeight >= 210000 && nHeight < 220000) nSubsidy = 9 * COIN;
    else if (nHeight >= 220000 && nHeight < 230000) nSubsidy = 8 * COIN;
    else if (nHeight >= 230000 && nHeight < 240000) nSubsidy = 7 * COIN;
    else if (nHeight >= 240000 && nHeight < 250000) nSubsidy = 6 * COIN;
    else if (nHeight >= 250000) nSubsidy = 5 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    // no MN reward for blocks < LAST_POW_BLOCK since they're POW mined...
    if (nHeight >= Params().LAST_POW_BLOCK() && nHeight < 20000) ret = blockValue * 0.90;
    else if (nHeight >= 20000 && nHeight < 30000) ret = blockValue * 0.71;
    else if (nHeight >= 30000 && nHeight < 50000) ret = blockValue * 0.72;
    else if (nHeight >= 50000 && nHeight < 60000) ret = blockValue * 0.73;
    else if (nHeight >= 60000 && nHeight < 70000) ret = blockValue * 0.74;
    else if (nHeight >= 70000 && nHeight < 80000) ret = blockValue * 0.75;
    else if (nHeight >= 80000 && nHeight < 90000) ret = blockValue * 0.76;
    else if (nHeight >= 90000 && nHeight < 100000) ret = blockValue * 0.77;
    else if (nHeight >= 100000 && nHeight < 110000) ret = blockValue * 0.78;
    else if (nHeight >= 110000 && nHeight < 120000) ret = blockValue * 0.79;
    else if (nHeight >= 120000 && nHeight < 130000) ret = blockValue * 0.80;
    else if (nHeight >= 130000 && nHeight < 140000) ret = blockValue * 0.81;
    else if (nHeight >= 140000 && nHeight < 150000) ret = blockValue * 0.82;
    else if (nHeight >= 150000 && nHeight < 160000) ret = blockValue * 0.83;
    else if (nHeight >= 160000 && nHeight < 170000) ret = blockValue * 0.84;
    else if (nHeight >= 170000 && nHeight < 180000) ret = blockValue * 0.85;
    else if (nHeight >= 180000 && nHeight < 190000) ret = blockValue * 0.86;
    else if (nHeight >= 190000 && nHeight < 200000) ret = blockValue * 0.87;
    else if (nHeight >= 200000 && nHeight < 210000) ret = blockValue * 0.88;
    else if (nHeight >= 210000 && nHeight < 220000) ret = blockValue * 0.89;
    else if (nHeight >= 220000) ret = blockValue * 0.90;
...
{
    RenameThread("ZNDECoin-scriptch");
