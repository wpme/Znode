...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ZNDECoin Core ZNDECoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ZNDECoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ZNDECoin transaction") + "\n" +
                               "  ZNDECoin-tx [options] -create [commands]   " + _("Create hex-encoded ZNDECoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ZNDECoin transaction
