...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ZNDECoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ZNDECoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ZNDECoin features */
        {"ZNDECoin", "masternode", &masternode, true, true, false},
        {"ZNDECoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ZNDECoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ZNDECoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ZNDECoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ZNDECoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ZNDECoin", "startmasternode", &startmasternode, true, true, false},
        {"ZNDECoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ZNDECoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ZNDECoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ZNDECoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ZNDECoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ZNDECoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ZNDECoin", "mnbudget", &mnbudget, true, true, false},
        {"ZNDECoin", "preparebudget", &preparebudget, true, true, false},
        {"ZNDECoin", "submitbudget", &submitbudget, true, true, false},
        {"ZNDECoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ZNDECoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ZNDECoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ZNDECoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ZNDECoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ZNDECoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ZNDECoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ZNDECoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ZNDECoin", "mnsync", &mnsync, true, true, false},
        {"ZNDECoin", "spork", &spork, true, true, false},
        {"ZNDECoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ZNDECoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ZNDECoind, or the -server option to ZNDECoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ZNDECoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19222/\n";
}
