...
/** Utility functions used by the ZNDECoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ZNDECoin addresses in monospace font
...
// Parse "ZNDECoin:" URI into recipient object, return true on successful parsing
