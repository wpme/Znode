                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZNDECoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZNDECoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ZNDECoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZNDECoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZNDECoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZNDECoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZNDECoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZNDECoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZNDECoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZNDECoin Core help message to get a list with possible ZNDECoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZNDECoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZNDECoin network", "", count));
}
...
{
    QString strTitle = tr("ZNDECoin Core"); // default title
