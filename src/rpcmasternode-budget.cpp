...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"ZNDECoin-address\" monthy-payment\n"
            ...
            "5. \"ZNDECoin-address\":   (string, required) ZNDECoin address to send payments to\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"ZNDECoin-address\" monthy-payment \"fee-tx\"\n"
