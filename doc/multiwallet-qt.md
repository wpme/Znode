...
In order to support loading of multiple wallets in ZNDECoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ZNDECoin.cpp.
...
Changes to ZNDECoin.cpp
----------------------
ZNDECoin.cpp is the entry point into ZNDECoin-qt, and as such, will require some minor modifications to provide hooks for
