...
This mechanism has been integrated into Bitcore-Node-ZNDECoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ZNDECoin-Project/insight-api-ZNDECoin#web-socket-api](https://github.com/ZNDECoin-Project/insight-api-ZNDECoin#web-socket-api) 
* API: [https://github.com/ZNDECoin-Project/insight-api-ZNDECoin#swifttx-transactions](https://github.com/ZNDECoin-Project/insight-api-ZNDECoin#swifttx-transactions) 
...
By default, the ZNDECoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ZNDECoin Core daemon:
