...
ZNDECoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ZNDECoin_address\> \<monthly_payment_ZNDECoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ ZNDECoin, _12_ times over the course of a year totaling _24000_ ZNDECoin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ZNDECoin_address\> \<monthly_payment_ZNDECoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` ZNDECoin.
 ...
 * vote-many          - Vote on a ZNDECoin initiative
 * vote-alias         - Vote on a ZNDECoin initiative
 * vote               - Vote on a ZNDECoin initiative/budget
